    ...
    <div className="h-screen flex font-sans bg-white overflow-hidden">
      ...
      >
        ...
        <svg className="absolute inset-0 w-full h-full opacity-10 pointer-events-none" aria-hidden>
          ...
          <rect x="70%" y="55%" width="180" height="180" rx="40" fill="white" opacity="0.5" transform="rotate(20,900,600)" />
        </svg>

        {/* Logo */}
        <div className="relative z-10 flex items-center gap-5">
          <LogoIcon size={80} color="white" />
          <span className="text-5xl font-bold text-white tracking-tight">Vialtros</span>
        </div>
        ...
        <div className="relative z-10">
          ...
          <p className="mt-4 text-blue-200 text-lg max-w-sm leading-relaxed">
            Sabe exactamente dónde está el vehículo y cuándo llegará, desde cualquier dispositivo.
          </p>
        ...
        {/* Footer */}
        <p className="relative z-10 text-blue-300 text-xs">© 2026 Vialtros. Todos los derechos reservados.</p>
      </div>
      ...
      <div className="flex flex-col justify-center items-center w-full lg:w-[560px] px-12 py-8 bg-white overflow-y-auto">
        ...
        <div className="w-full max-w-md">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-1">Iniciar sesión en Vialtros</h2>
          <p className="text-sm text-gray-400 mb-8">Ingresa tus credenciales para acceder al panel</p>
