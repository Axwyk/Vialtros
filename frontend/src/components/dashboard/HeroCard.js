  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <path
          d="M12 115 C40 90 75 60 115 44 L178 30"
          stroke="#93C5FD"
          strokeWidth="2"
          strokeDasharray="5 3"
          fill="none"
        ...
        />
        <path
          d="M12 128 C45 110 75 98 108 92 C138 87 162 100 178 114"
          stroke="#6EE7B7"
          strokeWidth="2"
          strokeDasharray="5 3"
          fill="none"
      ...
      <div
        className="absolute"
        style={{ left: "57%", top: "27%", transform: "translate(-50%,-50%)" }}
      >
        <span
          className="absolute inline-flex h-3 w-3 rounded-full bg-blue-300 opacity-60 animate-ping"
      ...
      <div
        className="absolute"
        style={{ left: "62%", top: "66%", transform: "translate(-50%,-50%)" }}
      >
        <span
          className="absolute inline-flex h-2.5 w-2.5 rounded-full bg-emerald-300 opacity-60 animate-ping"
...
export default function HeroCard({ role }) {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="absolute right-12 -bottom-8 w-32 h-32 rounded-full"
        style={{ background: "rgba(255,255,255,0.04)" }}
      />
      ...
      <div className="relative z-10 flex-1">
        ...
        <p
          className="text-sm text-blue-100 mb-5 max-w-xs leading-relaxed"
          style={{ opacity: 0.9 }}
        >
          Monitorea rutas activas, localiza conductores y sigue cada recorrido
          en tiempo real.
        </p>
        {trackingEnabled ? (
          <Link
